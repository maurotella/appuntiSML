...
\begin{aligned}
    ...
    &S_{\ell'}^+ = \{ (x_3,+1)(x_6,+1),(x_8,+1),(x_9,+1) \} & \NlposOne=4 
        & \qquad \frac{\NlposOne}{N_{\ell'}}=0.8 \\
    &S_{\ell'}^- = \{ (x_4,-1) \} & \NlnegOne=1 & \qquad \frac{\NlnegOne}{N_{\ell'}}=0.2 \\
\end{aligned}
$$
L'ottanta percento degli esempi che raggiungono $\ell'$ ha etichetta positiva, si può quindi
...
\begin{aligned}
    ...
    &S_{\ell''}^- = \{ (x_2,-1),(x_5,-1),(x_7,-1) \} & \NlnegTwo=3 
        & \qquad \frac{\NlnegTwo}{N_{\ell''}}=0.75 \\
\end{aligned}
$$
Il settantacinque percento degli esempi che raggiungono $\ell''$ ha etichetta negativa, si può quindi
affermare che l'etichetta $y_{\ell''}=-1$.